                                          ...
                                          <>
                                            <div className="opacity-0 group-hover:opacity-100 flex items-center transition-opacity">
                                              ...
                                              <Tooltip>
                                                ...
                                                <TooltipContent side="bottom" sideOffset={6} align="end" className="rounded-md bg-zinc-900 text-white px-2.5 py-1 text-xs font-semibold border-none" collisionPadding={10}>
                                        ...
                                        {isMessageSaved ? (
                                          <>
                                            <Tooltip>
                                              ...
                                              <TooltipContent side="bottom" sideOffset={6} align="start" className="rounded-md bg-zinc-900 text-white px-2.5 py-1 text-xs font-semibold border-none" collisionPadding={10}>
                                                <p>Forget Memory</p>
                                              </TooltipContent>
                                            </Tooltip>
