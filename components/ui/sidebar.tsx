...
const Sidebar: React.FC<SidebarProps> = ({
  ...
  return (
    <div className={className}>
      {!isOpen && (
        <Button onClick={onOpen} variant="ghost" className={cn("top-left-icon p-2 hover:bg-transparent transition-colors", outerIconColorClass)} aria-label="Open sidebar">
          {isMobile ? (
          ...
          <div>
            <SheetHeader className="flex flex-row items-center justify-between -mt-2">
              ...
              <Button
                onClick={onClose}
                variant="ghost"
                className="top-left-icon p-2 rounded-md text-[hsl(var(--icon-secondary))] hover:text-[hsl(var(--icon-primary))] hover:bg-transparent transition-colors"
              >
                {isMobile ? (
