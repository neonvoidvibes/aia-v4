        ...
        {messages.map((message: Message) => {
          ...
          return (
            ...
            >
              <div
                className={cn(
                  "message-bubble max-w-[85%] px-4 py-2 rounded-2xl text-base md:text-sm",
      ...
      <div className="p-2 border-t">
        <div className="relative flex items-center">
          <input
            ...
            className="w-full bg-transparent border-none outline-none px-3 py-2 text-base md:text-sm text-[hsl(var(--input-field-text-color))]"
            disabled={isLoading}
          />
          <button
            type="button"
