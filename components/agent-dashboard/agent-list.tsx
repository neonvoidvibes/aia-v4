      ...
      <Card className="border-none shadow-none bg-transparent flex-1 flex flex-col min-h-0">
        <CardHeader className="p-0 mb-4 flex-shrink-0">
          <div className="flex items-start justify-between gap-4 min-w-0">
            <CardTitle className="text-xl md:text-2xl font-bold truncate flex-1">Manage Agents</CardTitle>
            <Button onClick={onCreateNew} className="!hidden md:!inline-flex flex-shrink-0 whitespace-nowrap">
